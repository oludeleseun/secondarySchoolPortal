...
// Create page object
$teachers_teacherImage_blobview = new cteachers_teacherImage_blobview();
$Page =& $teachers_teacherImage_blobview;

// Page init
$teachers_teacherImage_blobview->Page_Init();

// Page main
$teachers_teacherImage_blobview->Page_Main();
?>
<?php
$teachers_teacherImage_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cteachers_teacherImage_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'teachers_teacherImage_blobview';
	...
	//
	function cteachers_teacherImage_blobview() {
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('teachers', 'x_teacherImage');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				if (trim(strval($rs->fields('teacherImage'))) <> "") {
					header("Content-Disposition: attachment; filename=" . $rs->fields('teacherImage'));
				}
				$objBinary->Value = $rs->fields('teacherImage');
