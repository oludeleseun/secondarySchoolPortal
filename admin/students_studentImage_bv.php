...
// Create page object
$students_studentImage_blobview = new cstudents_studentImage_blobview();
$Page =& $students_studentImage_blobview;

// Page init
$students_studentImage_blobview->Page_Init();

// Page main
$students_studentImage_blobview->Page_Main();
?>
<?php
$students_studentImage_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cstudents_studentImage_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'students_studentImage_blobview';
	...
	//
	function cstudents_studentImage_blobview() {
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('students', 'x_studentImage');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				if (trim(strval($rs->fields('studentImage'))) <> "") {
					header("Content-Disposition: attachment; filename=" . $rs->fields('studentImage'));
				}
				$objBinary->Value = $rs->fields('studentImage');
