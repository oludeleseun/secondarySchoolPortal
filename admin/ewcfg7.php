...
define("EW_PROJECT_NAME", "feghas_SSP", TRUE); // Project name
define("EW_RANDOM_KEY", 'JLTmGcPEJ9jXs49r', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "feghas_SSP.css", TRUE); // Project stylesheet file name
...
// User table filters
define("EW_USER_NAME_FILTER", "(`adminUsername` = '%u')",  TRUE);
...
define("EW_THUMBNAIL_DEFAULT_WIDTH", 100, TRUE); // Thumbnail default width
define("EW_THUMBNAIL_DEFAULT_HEIGHT", 100, TRUE); // Thumbnail default height
